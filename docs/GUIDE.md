...
туда; отмена и правило номера те же.
...
**RAW** переключает обе половины. Третий файл в выделении возвращает одну
картинку.
