...
создавать, перетаскивать наружу (пока — только «Извлечь…» или `Ctrl` + `C`
и вставка в папку). Миниатюр внутри нет — значки по расширению; поиск по
...
- Перетаскивание из архива в другие программы; запись внутрь архива;
  создание архива; ввод пароля; поиск внутри архива.
