...
| Раздел | Что там |
|---|---|
| **Основное** | Последняя папка при запуске, автообновление списка, быстрое чтение первых файлов при открытии папки (значки того, что на экране, раньше остального), стрелки в дереве, подтверждение при удалении в корзину и при перемещении |
