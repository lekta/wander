...
public static partial class Strings {
    ...
    /// <summary>Фокус-пикинг: чёткие грани по полному кадру - где резко. Alt - без подсветки</summary>
    public static string HelperFocusTip => Get(nameof(HelperFocusTip));

    /// <summary>Резкость 0-100 по середине кадра: у кнопок и на миниатюрах галереи</summary>
