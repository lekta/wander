...
public static class ImageFolderProbe {
    /// <summary>Share of content files that must be pictures. Strictly more than half.</summary>
    ...
    /// </summary>
    public static bool IsImageFolder(IReadOnlyList<FileSystemEntry> entries, CompanionResolver companions) {
        int content = 0;
        int images = 0;
        ...
        return images > 0 && images > content * Threshold;
    }
